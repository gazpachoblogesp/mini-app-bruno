...
import { ArrowLeft, Flame, Zap, Target, Calendar, Trophy, Settings, ChevronRight, Crown, Star, BookOpen } from "lucide-react";
        ...
        >
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-bold text-primary">{userStats.xp} / {userStats.xpToNextLevel} XP</span>
            </div>
